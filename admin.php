...
<table width="800" align="center" border="1" cellspacing="0" bordercolordark="white" bordercolorlight="black" height="223">
        ...
        <td height="45" width="120">
                <p style="margin-left:5pt;"><font face="맑은 고딕"><span style="font-size:10pt;"><b>관리자1</b></span></font></p>
        </td>
        ...
        <tr>
            <td height="45" width="120">
                <p style="margin-left:5pt;"><font face="맑은 고딕"><span style="font-size:10pt;"><b>관리자2</b></span></font></p>
            </td>
        ...
        <tr>
            <td colspan="2" height="44" width="794">
                <p align="center"><font face="맑은 고딕"><span style="font-size:10pt;"><input type="hidden" name="mode" value="admin"><input type="submit" name="submit" value=" 관리자 로그인 " style="font-family:'맑은 고딕'; font-size:9pt;"></span></font></p>
            </td>
        </tr>
</table>
</form>
